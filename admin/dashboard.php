...
<body>
	...
	?>
	<nav class="navbar navbar-info bg-info p-3">
	...
	<div class="container-fluid">
		<div class="row">
			<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
				<div class="position-sticky">
					<ul class="nav flex-column">
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="/zenius/project/admin/dashboard.php">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
				...
				?>
					<div class="col-12 col-md-6 col-lg-3 mb-4 mb-lg-0 ms-2">
						<div class="card h-100">
							<div class="card-header"><?php echo($data['type']) ;?></div>
							<div class="card-body">
								<h6 class="card-title"><?php echo($data['title']); ?></h6>
								<p class="card-text">
								<?php echo($data['snippet']); ?>
									<form action="./berita/index.php" method="get">
										<input type="hidden" name="idberita" id="idberita" value="<?php echo $data['Id'];?>">
